          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="  ">
              <img
                ...
                alt="logo"
              />
              <p className="text-sm font-bold pl-3  text-gray-900  dark:text-white">
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div className="flex justify-between">
                <button className="px-2 py-2 border flex gap-2 border-slate-200 rounded-lg text-white hover:border-slate-400 hover:text-red-600 hover:shadow transition duration-150">
                  <img
                    className="w-6 h-6"
