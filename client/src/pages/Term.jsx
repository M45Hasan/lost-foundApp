...
const Term = () => {
  ...
  return (
    <>
      <nav className="bg-white dark:bg-gray-900  w-full top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2">
            <button
              type="button"
              className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 md:px-4 py-1 md:py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Register Now
            </button>
          </div>
      ...
      {!term && (
        <div className="w-full h-full  shadow-lg p-4 bg-slate-300 ">
          <div className="md:w-[67%] lg:w-[80%]  md:p-8 ">
            <p className="mb-6">
              <span className="font-bold">General Terms </span><br/>
              ...
              between you and Preline. Under no circumstances shall Preline team
              ...
              materials on this site, even if Preline team or an authorized
              ...
              assume any costs thereof. Preline will not be responsible for any
            ...
            <p className="mb-6">
              <span className="font-bold">Products </span><br/>
              All products and services are delivered by Preline electronically
              and you can access your downloads from your profile page. Preline
              is not responsible for any technological delays beyond our
            ...
            <p className="mb-6">
              <span className="font-bold">Security </span><br/> Preline does not
              process any order payments through the website. All payments are
              processed securely through online payment provider (e.g. PayPal,
              Stripe), a third party online payment provider. Feel free to
              contact us about our security policies. 
              </p>
              <p className="mb-6">
              <span className="font-bold"> Ownership </span><br/>
              Ownership of the
              product is governed by the usage license selected by the seller.
              </p>
              <p className="mb-6">

              <span className="font-bold">Changes to terms</span> <br/>
              If we change our terms of use we will post those
              changes on this page. Registered users will be sent an email that
      ...
      <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Lost and Found™</a>. All Rights Reserved.
        </span>
