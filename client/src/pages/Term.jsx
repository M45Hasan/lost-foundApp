      ...
      {!term && (
        <div className="w-full h-full  shadow-lg p-4 bg-slate-300 ">
          <div className="md:w-[67%] lg:w-[80%]  md:p-8 ">
            <p className="mb-6">
              <span className="font-bold">General Terms </span>
              <br />
            ...
            <p className="mb-6">
              ...
              <br /> Preline does not process any order payments through the
              website. All payments are processed securely through online
              payment provider (e.g. PayPal, Stripe), a third party online
